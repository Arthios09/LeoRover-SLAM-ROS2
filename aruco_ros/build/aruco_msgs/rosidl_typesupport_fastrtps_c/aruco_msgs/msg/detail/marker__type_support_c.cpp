...
#include "aruco_msgs/msg/detail/marker__rosidl_typesupport_fastrtps_c.h"
...
using _Marker__ros_msg_type = aruco_msgs__msg__Marker;
...
static uint32_t _Marker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_msgs__msg__Marker(
...
static size_t _Marker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_msgs__msg__Marker(
