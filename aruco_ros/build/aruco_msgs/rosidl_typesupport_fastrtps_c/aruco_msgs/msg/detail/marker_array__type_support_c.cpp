...
#include "aruco_msgs/msg/detail/marker_array__rosidl_typesupport_fastrtps_c.h"
...
#include "aruco_msgs/msg/detail/marker__functions.h"  // markers
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_aruco_msgs__msg__Marker(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_aruco_msgs__msg__Marker(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_msgs, msg, Marker)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_aruco_msgs
...
using _MarkerArray__ros_msg_type = aruco_msgs__msg__MarkerArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: markers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aruco_msgs, msg, Marker
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: markers
  {
    ...
    if (ros_message->markers.data) {
      aruco_msgs__msg__Marker__Sequence__fini(&ros_message->markers);
    }
    if (!aruco_msgs__msg__Marker__Sequence__init(&ros_message->markers, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aruco_msgs__msg__Marker(
...
static uint32_t _MarkerArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_msgs__msg__MarkerArray(
  ...
  size_t current_alignment)
{
  ...
  // member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_aruco_msgs__msg__Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _MarkerArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_msgs__msg__MarkerArray(
