...
#include "aruco_msgs/msg/detail/marker_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aruco_msgs::msg::Marker &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aruco_msgs::msg::Marker &);
size_t get_serialized_size(
  const aruco_msgs::msg::Marker &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const aruco_msgs::msg::MarkerArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      aruco_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_msgs::msg::MarkerArray & ros_message)
{
  // Member: header
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      aruco_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aruco_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        aruco_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const aruco_msgs::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_msgs::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  return &aruco_msgs::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_msgs, msg, MarkerArray)() {
  return &aruco_msgs::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
