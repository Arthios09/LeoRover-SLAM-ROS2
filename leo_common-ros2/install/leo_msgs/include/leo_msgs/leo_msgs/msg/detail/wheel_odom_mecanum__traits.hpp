  ...
  std::ostream & out)
{
  ...
  {
    out << "velocity_lin_x: ";
    rosidl_generator_traits::value_to_yaml(msg.velocity_lin_x, out);
    out << ", ";
  }
  ...
  {
    out << "velocity_lin_y: ";
    rosidl_generator_traits::value_to_yaml(msg.velocity_lin_y, out);
    out << ", ";
  }
...
inline std::string to_yaml(const WheelOdomMecanum & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const leo_msgs::msg::WheelOdomMecanum & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const leo_msgs::msg::WheelOdomMecanum & msg)
{
